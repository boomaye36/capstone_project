...
public class Naver_Sens_V2 {
	...
	public void send_msg(String tel, String rand) {
        ...
        String accessKey = "RT4JeKrKCfRZmDHsvHQS";                     						// 개인 인증키
        String secretKey = "saH3LLG9EBi2o2CxpM54PEirldTERMsuf5KFvcoz";  										// 2차 인증을 위해 서비스마다 할당되는 service secret
        String serviceId = "ncp:sms:kr:299537625959:capstone_project";        									// 프로젝트에 할당된 SMS 서비스 ID
